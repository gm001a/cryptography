    ...
    <main class="container">
        <div class="card">
            <div class="card bg-light">
                <div>
                    <h4>Encriptación por HASH V2</h4><br>
                    <p>Encripta contraseña o compara si su clave es correcta</p>
                    <form action="c_hash2.php" method="POST">
                        ...
                        <br><br>
                        <div class="col-md-12">
                            <input type="radio" name="opt_hash2" id="opt_hash2" value="encrypt" required><label class="col-md-1" for=""> cifrar </label> 
                            <input type="radio" name="opt_hash2" id="opt_hash2" value="verify" required><label class="col-md-2" for=""> verificar: </label>
